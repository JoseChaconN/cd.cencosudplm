<x-layout>
	...
	<div class="col-lg-12">
		<div class="card shadow ">
	        <div class="card-header py-3">
	            <h6 class="m-0 font-weight-bold text-primary">Plantilla de Inspección SGL-RE-CC-027</h6>
	        </div>
	        <form method="POST" id="inspeccionForm" enctype="multipart/form-data" action="{{ (!empty($inspeccion->id)) ? route('inspecciones.update',$inspeccion->id) : route('inspecciones.store') }}">
                ...
                <input type="hidden" name="planilla" value="1">
	        	...
	        	<div class="card-body border-left-primary">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xs-6">
                            <div class="form-group">
                                <label class="font-weight-bold" >Retiro de muestra</label>
                                <select name="retiro_muestra" class="form-control form-control-sm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xs-6">
                            <div class="form-group">
                                <label class="font-weight-bold" >Días de Traslado:</label>
                                <input type="text" name="dias_traslado" class="form-control form-control-sm" placeholder="Días de Traslado" value="{{$inspeccion->dias_traslado}}">
                            </div>
                        </div>
	        		</div>
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xs-6">
                            <div class="form-group">
                                <label class="font-weight-bold" >T° Rotulada:</label>
                                <input type="text" name="t_rotulada" class="form-control form-control-sm" placeholder="T° Rotulada" value="{{$inspeccion->t_rotulada}}">
                            </div>
                        </div>
	        		</div>
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xs-6">
                            <div class="form-group">
                                <label class="font-weight-bold" >Fecha elaboración otorgada:</label>
                                <input type="date" name="fecha_elaboracion_otorgada" class="form-control form-control-sm" placeholder="Fecha elaboración otorgada" value="{{$inspeccion->fecha_elaboracion_otorgada}}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-xs-6">
                            <div class="form-group">
                                ...
                                <select name="pais_origen" class="selectpicker" data-live-search="true" data-width="100%" title="Seleccione">
                                    @foreach($paises as $pais)
                                        <option {{ (!empty($inspeccion->pais_origen) && $inspeccion->pais_origen == $pais->code) ? 'selected' : '' }} value="{{$pais->code}}">{{$pais->nombre}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4 col-xs-6">
                            <div class="form-group">
                                <label class="font-weight-bold" >Fecha vencimiento otorgada:</label>
                                <input type="date" name="fecha_vencimiento_otorgada" class="form-control form-control-sm" placeholder="Fecha vencimiento otorgada" value="{{$inspeccion->fecha_vencimiento_otorgada}}">
                            </div>
                        </div>
	        		</div>
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xs-6">
                            <div class="form-group">
                                <label class="font-weight-bold" >Respaldo microbiológicos origen:</label>
                                <select name="respaldo_microbiologico" class="form-control form-control-sm">
                                    <option value="">Seleccione</option>
                                    <option {{(!empty($inspeccion->respaldo_microbiologico) && $inspeccion->respaldo_microbiologico == 'sí') ? 'selected' : '' }} value="sí">Sí</option>
                                    <option {{(!empty($inspeccion->respaldo_microbiologico) && $inspeccion->respaldo_microbiologico == 'no') ? 'selected' : '' }} value="no">No</option>
                                </select>
                            </div>
                        </div>
	        		</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-12 col-xs-6">
                                    <div class="form-group">
                                        <label class="font-weight-bold" >Frigorífico Elaborador:</label>
                                        <select name="frigorifico_elaborador" class="form-control form-control-sm">
                                            <option value="NA">NA</option>
                                            <option value="sí">Sí</option>
                                            <option value="no">No</option>
                                        </select>
                                ...
                                <div class="col-md-12 col-xs-6">
                                    <div class="form-group">
                                        <label class="font-weight-bold" >N° Planta Faenadora:</label>
                                        <select name="n_planta_faenadora" placerholder="Sif" class="form-control form-control-sm">
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-12 col-xs-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-xs-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="autorizado_por" class="form-control form-control-sm" placeholder="Autorizado por" value="{{$inspeccion->autorizado_por}}">
                                    </div>
                                </div>
                                <div class="col-md-12 col-xs-6">
                                    <div class="form-group">
                                        <label class="font-weight-bold" >Tipo de Importación:</label>
                                        <select name="tipo_importacion" class="form-control form-control-sm">
                                            <option value="">Seleccione</option>
                                            <option {{(!empty($inspeccion->tipo_importacion) && $inspeccion->tipo_importacion == 'Directa') ? 'selected' : '' }} value="Directa">Directa</option>
                                            <option {{(!empty($inspeccion->tipo_importacion) && $inspeccion->tipo_importacion == 'Por Terceros') ? 'selected' : '' }} value="Por Terceros">Por Terceros</option>
                                            <option {{(!empty($inspeccion->tipo_importacion) && $inspeccion->tipo_importacion == 'Nacional') ? 'selected' : '' }} value="Nacional">Nacional</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-12 col-xs-6">
                                    <div class="form-group">
                                        <label class="font-weight-bold" >N° Guía de despacho:</label>
                                        <input type="text" name="n_guia_despacho" class="form-control form-control-sm" placeholder="N° Guía de despacho" value="{{$inspeccion->n_guia_despacho}}">
                                    </div>
                                </div>
                                <div class="col-md-12 col-xs-6">
                                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-6 col-xs-6">
                                    <div class="form-group">
                                        <label class="font-weight-bold" >Embalaje:</label>
                                        <select name="embalaje" class="form-control form-control-sm">
                                            <option {{(!empty($inspeccion->embalaje) && $inspeccion->embalaje == 'Manchadas') ? 'selected' : '' }} value="Manchadas">Manchadas</option>
                                            <option {{(!empty($inspeccion->embalaje) && $inspeccion->embalaje == 'Manchadas') ? 'selected' : '' }} value="Manchadas">Deterioradas</option>
                                            <option {{(!empty($inspeccion->embalaje) && $inspeccion->embalaje == 'Humedas') ? 'selected' : '' }} value="Humedas">Húmedas</option>
                                            <option {{(!empty($inspeccion->embalaje) && $inspeccion->embalaje == 'Sin Observaciones') ? 'selected' : '' }} value="Sin Observaciones">Sin Observaciones</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6 col-xs-6">
                                                        ...
                                                        <div class="col-md-12 mt-3" id="corte_{{$producto->id}}">
                                                            <div class="card shadow mb-4">
                                                                <div class="card-header">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6 text-right">
                                                                            ...
                                                                            <button class="btn btn-sm btn-primary add-more-box" type="button" onclick="fnAddMoreBoxExist({{$producto->id}})">Agregar Cajas</button>
                                                                            <button class="btn btn-sm btn-primary add-more-copy-box" type="button">Agregar Cajas Copiando</button>
                                                                ...
                                                                <div class="collapse" id="collapseCardBoxProducto_{{$producto->id}}">
                                                                    <div class="card-body">
                                                                        <div class="row box-corte-{{$producto->id}}">
    ...
    <script>
        ...
        function fnAddMoreProducto(id,corte,sap,vida_util,tolerancia_ingreso,tolerancia_despacho,dias_antes_vence) {
        ...
        function fnAddMoreBoxExist(number) {
            //n_cajas_revisadas = parseInt($('#n_cajas_revisadas').val());
		    //$('#n_cajas_revisadas').val(n_cajas_revisadas+1).trigger("change");            
            random = Math.round(Math.random()*(9999999999-1)+parseInt(1));
            clone = $("#corte_box_").clone().removeClass("d-none").addClass('count-box');
            clone.attr("id", "corte_box_"+random).removeClass("d-none").addClass('box-'+number);
            clone.find('.id-corte-box').attr('name','id_corte_box_exist['+number+']['+random+']').val(random);
            clone.find('.f-faena-box').attr('name','f_faena_box_exist['+number+']['+random+']');
            clone.find('.f-elaboracion-box').attr('name','f_elaboracion_box_exist['+number+']['+random+']');
            clone.find('.f-vencimiento-box').attr('name','f_vencimiento_box_exist['+number+']['+random+']');
            clone.find('.temperatura-box').attr('name','temperatura_box_exist['+number+']['+random+']');
            clone.find('.frigorifico-origen-box').attr('name','frigorifico_origen_box_exist['+number+']['+random+']');
            clone.find('.unidad-defectuosas-box').attr('name','unidad_defectuosas_box_exist['+number+']['+random+']');
            clone.find('.kg-rechazados-box').attr('name','kg_rechazados_box_exist['+number+']['+random+']');
            clone.find('.defecto-box').attr('name','defecto_box_exist['+number+']['+random+'][]').addClass('selectpicker').selectpicker('render');
            clone.find('.observacion-box').attr('name','observacion_box_exist['+number+']['+random+']');
            clone.find('.archivo-box').attr('name','archivo_box_exist['+number+']['+random+']');
            clone.find('.btn-delete-box').attr("onclick","fnDeleteBox("+number+","+random+")");
